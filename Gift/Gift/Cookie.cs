...
namespace Gift
{
    class Cookie : AbstractComponent
    {
        //Fields
        ...
        public Cookie(string type, string name, double weight, double calories, double sugar, double tasteMark, string filling, string form)
